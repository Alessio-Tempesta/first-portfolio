...
import FotoProfilo from "../assets/Foto-profilo-removebg-preview.png";
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-right ml-10 text-purple-500 py-4 max-w-md">Ciao! Sono Tempesta Alessio,<br /> un appassionato sviluppatore front-end con una fervida passione per l'innovazione e il design creativo. <br /> Le teconlogie che mi piacciono di più sono:
